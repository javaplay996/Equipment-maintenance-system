...
public class WeixiuyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WeixiuyuanEntity user = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody WeixiuyuanEntity weixiuyuan){
    	...
    	WeixiuyuanEntity user = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("zhanghao", weixiuyuan.getZhanghao()));
		if(user!=null) {
