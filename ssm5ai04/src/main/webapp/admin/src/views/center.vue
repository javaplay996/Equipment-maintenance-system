<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='weixiuyuan'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" readonly              placeholder="账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='weixiuyuan'"  label="姓名" prop="xingming">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='weixiuyuan'"  label="手机" prop="shouji">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.zhanghao)&& 'weixiuyuan'==this.flag){
      ...
      if( 'weixiuyuan' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
