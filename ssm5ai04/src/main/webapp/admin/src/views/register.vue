  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">设备配件管理和设备检修系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			<!-- <div v-if="tableName=='weixiuyuan'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='weixiuyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='weixiuyuan'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='weixiuyuan'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='weixiuyuan'">
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
      if((!this.ruleForm.zhanghao) && `weixiuyuan` == this.tableName){
      ...
      if(`weixiuyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
