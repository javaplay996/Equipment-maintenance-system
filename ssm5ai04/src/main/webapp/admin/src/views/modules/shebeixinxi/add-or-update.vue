<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="规格型号" prop="guigexinghao">
          <el-input v-model="ruleForm.guigexinghao" 
              placeholder="规格型号" clearable  :readonly="ro.guigexinghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="规格型号" prop="guigexinghao">
              <el-input v-model="ruleForm.guigexinghao" 
                placeholder="规格型号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="安全库存" prop="anquankucun">
          <el-input v-model="ruleForm.anquankucun" 
              placeholder="安全库存" clearable  :readonly="ro.anquankucun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="安全库存" prop="anquankucun">
              <el-input v-model="ruleForm.anquankucun" 
                placeholder="安全库存" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检修次数" prop="jianxiucishu">
          <el-input v-model="ruleForm.jianxiucishu" 
              placeholder="检修次数" clearable  :readonly="ro.jianxiucishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检修次数" prop="jianxiucishu">
              <el-input v-model="ruleForm.jianxiucishu" 
                placeholder="检修次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="寿命剩余" prop="shoumingshengyu">
          <el-input v-model="ruleForm.shoumingshengyu" 
              placeholder="寿命剩余" clearable  :readonly="ro.shoumingshengyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="寿命剩余" prop="shoumingshengyu">
              <el-input v-model="ruleForm.shoumingshengyu" 
                placeholder="寿命剩余" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guigexinghao = true;
          ...
          if(o=='anquankucun'){
            this.ruleForm.anquankucun = obj[o];
	    this.ro.anquankucun = true;
            continue;
          }
          if(o=='jianxiucishu'){
            this.ruleForm.jianxiucishu = obj[o];
	    this.ro.jianxiucishu = true;
            continue;
          }
          if(o=='shoumingshengyu'){
            this.ruleForm.shoumingshengyu = obj[o];
	    this.ro.shoumingshengyu = true;
            continue;
          }
        }
      }
