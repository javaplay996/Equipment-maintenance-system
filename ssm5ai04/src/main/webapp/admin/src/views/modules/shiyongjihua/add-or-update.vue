<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开始使用时间" prop="kaishishiyongshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kaishishiyongshijian" 
                type="date"
                placeholder="开始使用时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaishishiyongshijian" label="开始使用时间" prop="kaishishiyongshijian">
              <el-input v-model="ruleForm.kaishishiyongshijian" 
                placeholder="开始使用时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="计划使用时间" prop="jihuashiyongshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jihuashiyongshijian" 
                type="date"
                placeholder="计划使用时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jihuashiyongshijian" label="计划使用时间" prop="jihuashiyongshijian">
              <el-input v-model="ruleForm.jihuashiyongshijian" 
                placeholder="计划使用时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	kaishishiyongshijian : false,
	jihuashiyongshijian : false,
	beizhu : false,
      },
      ruleForm: {
        shebeibianhao: '',
        shebeimingcheng: '',
        kaishishiyongshijian: '',
        jihuashiyongshijian: '',
        beizhu: '',
      },
      rules: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeimingcheng = true;
          ...
          if(o=='kaishishiyongshijian'){
            this.ruleForm.kaishishiyongshijian = obj[o];
	    this.ro.kaishishiyongshijian = true;
            continue;
          }
          if(o=='jihuashiyongshijian'){
            this.ruleForm.jihuashiyongshijian = obj[o];
	    this.ro.jihuashiyongshijian = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shiyongjihua/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shiyongjihuaCrossAddOrUpdateFlag = false;
                  this.parent.search();
